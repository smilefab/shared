...
os.chdir('C:/Users/Fabian/Documents/Master/LR - IP/Project/shared/results/reproduced/dqn_ducb_tuned')
...
folders = ['dqn_ducb_tuned', 'multidqn', 'dqn_prism']
...
with np.errstate(invalid='ignore'):
    for i, g in enumerate(games):
        ...
        for act in activation:
            for r in reg:
                ...
                ducb = np.load('dqn_ducb_tuned/' + s + '/scores.npy')[:, i]
    ...
    plt.legend(['MULTI', 'PRISM', 'TUNED D-UCB'], fontsize=20, loc='lower right')

    tasks = np.load('dqn_ducb_tuned/noreg-sigmoid/tasks.npy')
