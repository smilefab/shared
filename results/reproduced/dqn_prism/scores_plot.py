...
os.chdir('C:/Users/Fabian/Documents/Master/LR - IP/Project/shared/results/reproduced/dqn_prism')
...
folders = ['dqn', 'multidqn', 'dqn_prism']
...
with np.errstate(invalid='ignore'):
    for i, g in enumerate(games):
        ...
        for act in activation:
            for r in reg:
                ...
                plt.fill_between(np.arange(51), single_mean - single_err, single_mean + single_err, alpha=.5, label='_nolegend_')
    ...
    tasks = np.load('dqn_prism/noreg-sigmoid/tasks.npy')
